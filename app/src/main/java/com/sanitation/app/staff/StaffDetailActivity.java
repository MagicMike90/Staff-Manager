...
public class StaffDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(StaffDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(StaffDetailFragment.ARG_ITEM_ID));
            StaffDetailFragment fragment = new StaffDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.staff_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, StaffListActivity.class));
            return true;
        }
